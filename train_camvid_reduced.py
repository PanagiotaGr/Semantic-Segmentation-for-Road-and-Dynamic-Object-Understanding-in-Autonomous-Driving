...
NUM_CLASSES = 5   # background, road, sidewalk, vehicle, pedestrian
IMG_SIZE = (256, 256)
BATCH_SIZE = 4
EPOCHS = 10
LR = 1e-3
...
REDUCED_MAP = {
    ...
    10: 0,  # Bicyclist -> background
    11: 0   # Void -> background
}
...
for epoch in range(EPOCHS):
    ...
    if miou > best_miou:
        ...
        torch.save(model.state_dict(), "models/best_unet_camvid_reduced.pth")
        print("Saved best reduced model.")

print(f"Training complete. Best reduced mIoU: {best_miou:.4f}")
